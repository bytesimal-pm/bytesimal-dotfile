...
-- Dark mode
hl.env("GTK_THEME", "Adwaita:dark")       -- GTK3 apps (needs gnome-themes-extra)
hl.env("QT_QPA_PLATFORMTHEME", "qt6ct")   -- Qt apps, palette set in ~/.config/qt6ct
...
local closeWindowBind = hl.bind(mainMod .. " + T", hl.dsp.window.close())
...
local function screenshot(grimArgs)
    return "mkdir -p " .. shotDir .. " && f=" .. shotFile .. " && grim " .. grimArgs .. " \"$f\" && wl-copy < \"$f\""
end
hl.bind("Print",              hl.dsp.exec_cmd("g=$(slurp) && " .. screenshot("-g \"$g\"")))  -- select region
hl.bind("SHIFT + Print",      hl.dsp.exec_cmd(screenshot("")))                               -- full screen
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("g=$(slurp -o) && " .. screenshot("-g \"$g\"")))  -- pick a monitor

...
- Wallpaper video (`~/Pictures/Wallpapers/zenitsu-white.webm`, 32 MB, 4K VP9 from youtube.com/watch?v=uWRYGYqR14I via `yt-dlp -f 313`; VP9 because the AMD iGPU hardware-decodes it, AV1 it can't) is **not** in the repo. Without it the background is black.
